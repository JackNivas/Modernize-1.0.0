                            ...
                            <div class="blog-custom-build">
                                ...
                                ?>
                                    <div class="post-media">
                                        <a href="postdetails.php?Id=<?php echo $row['post_id']; ?>" title="">
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <h4><a href="marketing-single.html" title=""><?php echo $row['posttitle']; ?></a></h4>
                                        <p><?php echo $row['postcomment']; ?></p>
                                        <small><a href="marketing-category.html" title=""><?php echo $row['postcategory']; ?></a></small>
